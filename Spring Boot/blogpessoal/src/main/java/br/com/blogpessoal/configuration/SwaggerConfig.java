...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/MariliaDev")
				.contact(contact()).build();
	}

	private static Contact contact() {

		return new Contact("Marilia Gabriely do Nascimento Silva", "https://github.com/MariliaDev", "mariliadevs@gmail.com");
